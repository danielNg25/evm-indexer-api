...
/// This is used to efficiently store and look up initialized ticks
...
// /// Calculate the sqrt price from a tick
...
//     if tick < 0 {
//         ratio = (1u128 << 128) / ratio;
//     }

//     U256::from(ratio)
// }

// /// Calculate the tick from a sqrt price
// pub fn sqrt_price_x96_to_tick(sqrt_price_x96: U256) -> i32 {
//     let mut ratio = sqrt_price_x96.to::<u128>();
//     let mut tick = 0i32;
...
//     let mut ratio_shifted = ratio;
//     while ratio_shifted > 0x100000000000000000000000000000000 {
//         ratio_shifted >>= 1;
//         tick += 1;
//     }
