...
contract ForkUniversalDexLoopingHookTest is Constant, Test {
    ...
    function testLoopp() public {
        ...
        universalRouter.swap(
            ...
            abi.encodePacked(
                ...
                address(0x915e897DafFBf232991a9ac1a35240318bF7e65D),
                address(0x1217BfE6c773EEC6cc4A38b5Dc45B92292B6E189),
                address(0x5d8D16F7de8637499A730D09A363E2EADaF01Dce),
                address(0x4200000000000000000000000000000000000006),
                address(0xDaC26c3ffe00ad0656f8Cd8752186d2f7D9ae789)
            )
        );
    ...
    function deploy() public returns (address) {
        ...
        sigsV3[2] = bytes4(
            keccak256("algebraSwapCallback(int256,int256,bytes)")
        );
        sigsV3[3] = bytes4(
            keccak256("squadV3SwapCallback(int256,int256,bytes)")
        );
        ...
        return address(universalRouter);
    }

    function deployLisk() public returns (address) {
        vm.startPrank(0xF90E54B26866edBffedAaAC63587163c0305fff7);
        deal(0xF90E54B26866edBffedAaAC63587163c0305fff7, 1 ether);

        bytes4[] memory sigs = new bytes4[](58); // V2
        sigs[0] = bytes4(
            keccak256("uniswapV3FlashCallback(address,uint256,uint256,bytes)")
        );
        sigs[1] = bytes4(
            keccak256("hook(address,uint256,uint256,bytes)")
        );
        sigs[2] = bytes4(keccak256("babyCall(address,uint256,uint256,bytes)"));
        sigs[3] = bytes4(
            keccak256("fstswapCall(address,uint256,uint256,bytes)")
        ...
        // Define V2 factory addresses
        address[] memory v2Factories = new address[](72);
        v2Factories[0] = 0x31832f2a97Fd20664D76Cc421207669b55CE4BC0; // joeCall
        v2Factories[1] = 0x858E3312ed3A876947EA49d572A7C42DE08af7EE; // arenaCall
        v2Factories[2] = 0x0841BD0B734E4F5853f0dD8d7Ea041c241fb0Da6; // pangolinCall
        v2Factories[3] = 0xBCfCcbde45cE874adCB698cC183deBcF17952812; // uniswapV2Call
        v2Factories[4] = 0x86407bEa2078ea5f5EB5A52B2caA963bC1F889Da; // sicleCall
...
// [2025-08-24 12:50:44] FAILED Block: 58722120 | Profit: 0.008791922231164365 | Tx: 0x809d094b7e092ee4b7be17eca5c7780b0ae25fe903fda2e8e49e5a1a68e9e26a | Source: 0x3bb08d30ce6d575147d054cd4dd01525d08448a780c05178221c8a8bf90eaa76 | Amount: 9.324788716199281625 |
// Path: 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c->0x47a90A2d92A8367A91EfA1906bFc8c1E05bf10c4
// --> 0x55d398326f99059fF775485246999027B3197955->0x247f51881d1E3aE0f759AFB801413a6C948Ef442
// --> 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c->0x6bbc40579ad1BBD243895cA0ACB086BB6300d636
// Metrics: TX: 0x3bb08d30ce6d575147d054cd4dd01525d08448a780c05178221c8a8bf90eaa76 | Received at: 2025-08-24 12:50:36.927 | Proccessed at: 2025-08-24 12:50:36.927 (+0ms) | Simulated at: 2025-08-24 12:50:36.936 (+9ms) | Sent at: 2025-08-24 12:50:36.936 (+0ms) | Executed at: 2025-08-24 12:50:44.093 (+7157ms) | Total time: 9ms
//  | Steps: 5319712486118312860, 4575705223247414520494, 963434854712503290, 5326093318166994009
